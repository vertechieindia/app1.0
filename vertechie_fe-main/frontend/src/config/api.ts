...
export const API_ENDPOINTS = {
    ...
    COMMUNITY: {
        ...
        UPDATE_GROUP: (id: string) => `/community/groups/${id}`,
        DELETE_GROUP: (id: string) => `/community/groups/${id}`,
        JOIN_GROUP: (id: string) => `/community/groups/${id}/join`,
        LEAVE_GROUP: (id: string) => `/community/groups/${id}/leave`,
        GROUP_CHAT: (id: string) => `/community/groups/${id}/chat-conversation`,
        UPLOAD: '/community/upload',
        ...
        UPDATE_EVENT: (id: string) => `/community/events/${id}`,
        DELETE_EVENT: (id: string) => `/community/events/${id}`,
        ...
        UPDATE_IDEA: (id: string) => `/community/combinator/ideas/${id}`,
        DELETE_IDEA: (id: string) => `/community/combinator/ideas/${id}`,
