...
import {
  applyJobFilters,
  normalizeExperienceForFilter,
  normalizeJobTypeForFilter,
...
const JobListings: React.FC = () => {
  ...
  const { filters, clearFilters, hasActiveFilters } = useJobSearch();
  ...
  useEffect(() => {
    setFilteredJobs(applyJobFilters(jobs, filters));
  }, [jobs, filters]);
